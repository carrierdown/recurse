...
export interface INode {
    ...
    parent?: INode;
    reference?: INode; // Not implemented. holds reference to another node in the case of statements like stack, +rm, etc.
    ...
    name?: string;
    generateVar?: (context: IContext, parent: INode) => IRecurseValue[]; // Used from a variable reference to generate its contents
}